...
| [`usb_display_usb35inch/`](usb_display_usb35inch/) | 3.5インチUSBスマートスクリーンの立ち上げ。CDC OUTキュー、向き、単色塗り、原色帯、カラーバー、1px市松、部分矩形、同じ全画面を1/3/8/24/48/96矩形に分けて送るスイープ、無通信での表示保持、輝度を確認する。画像はパネルで目視判定する | 3.5インチUSBスマートスクリーン（`1a86:5722`、`USB35INCHIPSV2`） | ✅ |
