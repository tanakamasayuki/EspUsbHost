...
速度のテストもする
ループバックを速度変更しながら他の機材でキャプチャして検証
ESP32-S3のGPIOを使ってシリアル受信がいいかも
ロジックアナライザを使うテストもやってみたいけれど機材増えるのは嫌だ

ライン設定（パリティ/ストップビット）はAPIと主要VCP変換を追加済み。CH34xのmark/spaceパリティと1.5ストップビットは実機マニュアルテスト後に判断する。
